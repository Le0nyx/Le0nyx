...
// Dino game constants
export const DINO_SPRITE_URL = 'assets/dino/100-offline-sprite.png';
export const DINO_GRAVITY = 1.02;
export const DINO_JUMP_VELOCITY = -18.6;
export const DINO_INITIAL_SPEED = 6.2;
